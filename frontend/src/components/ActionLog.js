...
export default function ActionLog({ logs }) {
  ...
  return (
    <div className="bg-desert-light dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-jaipur-gold dark:border-gray-700 transition-colors">
      ...
      <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1 transition-colors">
        {logs.map((log, index) => (
          ...
          >
            <span className="mt-1 text-[10px] flex-shrink-0">▶</span>
