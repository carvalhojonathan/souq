        ...
        <>
          ...
          <div className="grid grid-cols-4 gap-1 md:gap-2 flex-grow">
            <button
              ...
              className={`flex flex-row md:flex-row flex-col items-center justify-center py-1.5 px-1 md:px-2 gap-1 md:gap-2 rounded border-2 transition-all shadow-sm ${isMyTurn && canTakeOne ? "border-blue-500 bg-blue-50 dark:bg-blue-900/30 dark:border-blue-400 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/50" : "border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-400 dark:text-gray-500 opacity-50"}`}
            >
            ...
            <button
              ...
              className={`flex flex-row md:flex-row flex-col items-center justify-center py-1.5 px-1 md:px-2 gap-1 md:gap-2 rounded border-2 transition-all shadow-sm ${isMyTurn && canTakeCamels ? "border-yellow-500 bg-yellow-50 dark:bg-yellow-900/30 dark:border-yellow-500 text-yellow-700 dark:text-yellow-400 hover:bg-yellow-100 dark:hover:bg-yellow-900/50" : "border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-400 dark:text-gray-500 opacity-50"}`}
            >
