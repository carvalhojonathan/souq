  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-between min-h-[7rem] md:min-h-[8rem] p-2 bg-white dark:bg-gray-900 rounded border border-gray-300 dark:border-gray-700 w-full transition-colors relative overflow-x-auto overflow-y-hidden custom-scrollbar">
        {/* BARALHO (DECK) - Adicionado margin-left para afastar da borda esquerda */}
        <div className="flex flex-col items-center flex-shrink-0 w-[45px] sm:w-[70px] md:w-[85px] ml-2 sm:ml-4">
        ...
        {/* PILHA DE DESCARTE */}
        <div className="hidden sm:flex flex-col items-center flex-shrink-0 w-[55px] sm:w-[70px] md:w-[85px] mr-2">
